...
const ResumeSection = () => {
  ...
  // Open the resume automatically if the URL hash is #resume
  useEffect(() => {
  ...
  return (
    <section id="resume" className="py-20 section">
      <div className="container mx-auto px-4">
        <h2 className="section-title text-center mb-8">Resume</h2>
              ...
              <section className="mb-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">JavaScript, Svelte, Node.js, Python, C, C#, HTML/CSS, Bash, Linux</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Frameworks & Tools:</h4>
                    <p className="text-sm text-muted-foreground">Angular, .NET, MongoDB, Firebase, Twilio, APIs, UI/UX Design</p>
                  </div>
                  <div>
